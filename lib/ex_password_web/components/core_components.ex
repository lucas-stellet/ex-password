defmodule ExPasswordWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ExPasswordWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ExPasswordWeb.Gettext, "errors", msg, opts)
    # end
